...
## How to manually upload content

1. Press `Create+` to open the editor
2. Select `Upload from Computer` to import files from your computer
3. Select `Upload from Library` to add screenshots and videos from your saved recordings